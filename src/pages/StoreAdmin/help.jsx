      ...
      <div className="support-container">
        ...
        <header className="support-head">
          <div className="head-left">
            ...
            <p>
              Raise queries, track responses, and stay connected with the support team for
              any account or store issues.
            </p>
          </div>
          ...
          <div className="support-left">
            ...
            <div className="card secondary">
              ...
              <div className="card-body tips">
                <ul>
                  <li>
                    Include <strong>screenshots</strong> and exact error messages in your
                    description.
                  </li>
                  <li>
                  ...
                  <li>
                    Mark tickets as <strong>Resolved</strong> once your issue is fully
                    fixed.
                  </li>
                </ul>
              </div>
                  ...
                  filteredTickets.map((t) => (
                    <button
                      ...
                      className={`ticket-item ${
                        selectedTicket && selectedTicket.id === t.id ? "active" : ""
                      }`}

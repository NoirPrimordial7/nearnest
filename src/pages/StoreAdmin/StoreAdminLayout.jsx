...
const STORE_ADMIN_MENU = [
  {
    label: "Dashboard",
    path: (id) => `/store-admin/${id}/dashboard`,
  ...
  {
    label: "Support & Help",
    path: (id) => `/store-admin/${id}/support`,
                ...
                <header className={styles.topbar}>
                    ...
                    <div className={styles.topActions}>
                        ...
                        <div className={styles.actionWrap} ref={notifRef}>
                            ...
                            <div
                                className={`${styles.menu} ${styles.menuRight} ${notifOpen ? styles.menuOpen : ""
                                    }`}
                                role="menu"
                        ...
                        <div className={styles.actionWrap} ref={profileRef}>
                            ...
                            <div
                                className={`${styles.menu} ${styles.menuRight} ${profileOpen ? styles.menuOpen : ""
                                    }`}
                                role="menu"

...
export default function StoreSettings() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      try {
        ...
        setSavedLogoPreview(settings.logoUrl || null);
        ...
        if (!cancelled) {
          setToast("Could not load store settings.");
  ...
  /* ========= Save: copy draft -> saved & push to Firestore ========= */
  const handleSave = async () => {
    if (!storeId) {
      setToast("Missing store ID in URL.");
      setTimeout(() => setToast(""), 2600);
      return;
    }
    ...
    try {
      const payload = {
        settings: {
          ...
          logoUrl: savedLogoPreview, // real upload can be wired later
      ...
      setSavedLogoPreview(draftLogoPreview || savedLogoPreview || null);

      setToast("✅ Store settings saved successfully");
      setTimeout(() => setToast(""), 2600);
    } catch (err) {
      console.error("[StoreSettings] save error:", err);
      setToast("Could not save store settings.");
      setTimeout(() => setToast(""), 2600);
    } finally {
      setSaving(false);
      setBusy(false);
  ...
  return (
    <div className="settings-root">
      <div className="settings-container">
        ...
        {busy && (
          <div className="settings-busy-hint">
            Syncing settings with cloud…
          </div>
        )}
                  ...
                  {draftAddress.googleMapsUrl ? (
                    <>
                      ...
                      <div className="map-embed-wrapper">
                        <iframe
                          src={getEmbedUrl(draftAddress.googleMapsUrl)}
                          loading="lazy"
                    ...
                    <p>
                      Add a Google Maps URL or address above to preview
                      your draft location here.
                    </p>
                  )}
                </div>
              </div>
            ...
            <div className="settings-card">
              ...
              <div className="card-body form-grid">
                <div className="form-field full">
                  ...
                  <p className="hint">
                    Allow customers to place medicine orders from the
                    mobile app.
                  </p>
                </div>
            ...
            <div className="settings-card">
              ...
              <div className="card-body form-grid">
                ...
                <div className="form-field full">
                  ...
                  <p className="hint">
                    If enabled, additional verification may be required
                    as per regulation.
                  </p>
                </div>
                <div className="form-field full">
                ...
                <div className="card-body preview-body">
                  ...
                  <div className="map-placeholder compact">
                    ...
                    {savedAddress.googleMapsUrl ? (
                      ...
                      <p className="hint">
                        Save a Google Maps URL above to see a mini preview
                        here.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="preview-field">
                    ...
                    <div className="color-chip">
                      <span
                        className="color-dot"
                        style={{
                          background: savedBranding.primaryColor,
                        }}
                      />

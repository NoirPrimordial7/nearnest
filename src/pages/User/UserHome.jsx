        ...
        {stores.map(s => (
          ...
          >
            ...
            <div style={{
              ...
              borderRadius: 999,
              background:
                s.verificationStatus === "Approved" ? "#DCFCE7" :
                s.verificationStatus === "Rejected" ? "#FEE2E2" : "#E0F2FE",
              color:
                s.verificationStatus === "Approved" ? "#166534" :
                s.verificationStatus === "Rejected" ? "#991B1B" : "#075985"
            }}>
